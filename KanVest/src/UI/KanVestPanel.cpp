...
#include "Analyzer/RecommendationEngine.hpp"
...
KanVasX::UI::Text(Font(font), string, KanVasX::UI::AlignX::Left, offset, textColor);
  ...
  void Panel::ShowPortfolio()
  {
    ...
    KanVasX::ScopedColor tableHeader(ImGuiCol_TableHeaderBg, IM_COL32(20, 58, 88, 255));
    KanVasX::ScopedColor hovered(ImGuiCol_HeaderHovered, KanVasX::Color::BackgroundLight);
  ...
  void Panel::ShowStockRecommendation()
  {
