...
namespace ImSequencer
{
  ...
  [[maybe_unused]] static int min(int a, int b) { return (a < b) ? a : b; }
  [[maybe_unused]] static int max(int a, int b) { return (a > b) ? a : b; }
   ...
   bool Sequencer(SequenceInterface* sequence, int* currentFrame, bool* expanded, int* selectedEntry, int* firstFrame, int sequenceOptions)
   {
      ...
      // zoom in/out
     [[maybe_unused]] int frameOverCursor = 0;
      ...
      else
      {
         ...
         */
         ...
         if (hasScrollBar)
         {
           ...
           [[maybe_unused]] float handleRadius = (scrollBarMax.y - scrollBarMin.y) / 2;
